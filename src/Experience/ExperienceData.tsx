...
export let experience: ExperienceData[] = [
    {
        ...
        about: ["I spent a semester substitute teaching to see if a career in education was right for me. While I ultimately decided teaching wasn’t the best fit, I gained valuable insight into the k-12 system."]
    },
     {
